        ...
        for (Map<String, Object> map : list) {
            ...
            if (!StrUtils.isBlank(map.get("单位名称"))) {
                ...
                if (!StrUtils.isBlank(map.get("组织机构编码"))) {
                    ...
                    unit.setMainHallNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("厅局级正职领导职数"))));
                    unit.setDeputyHallNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("厅局级副职领导职数"))));
                    ...
                    unit.setOneResearcherNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("一级调研员职数"))));
                    unit.setTowResearcherNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("二级调研员职数"))));
                    unit.setThreeResearcherNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("三级调研员职数"))));
                    unit.setFourResearcherNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("四级调研员职数"))));
                    unit.setOneClerkNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("一级主任科员职数"))));
                    unit.setTowClerkNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("二级主任科员职数"))));
                    unit.setThreeClerkNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("三级主任科员职数"))));
                    unit.setFourClerkNum(StrUtils.strToInt(StrUtils.toNullStr(map.get("四级主任科员职数"))));
